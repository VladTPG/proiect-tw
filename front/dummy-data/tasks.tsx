...
const tasks: Task[] = [
  ...
  },
  {
    ...
    description:
        "Review the code changes in pull request #34 for the user profile feature.",
  ...
  },
  {
    ...
    description:
        "Create slides and materials for the upcoming project presentation.",
    deadline: new Date("2024-11-30T14:00:00"),
    status: "In Progress",
    priority: 4, // Medium
    userFK: 2,
    projectFK: 5,
